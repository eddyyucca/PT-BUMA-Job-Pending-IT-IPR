							...
							<div class="card">
								...
								<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="card-action ">
											<button type="button" class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#eviden">Approve</button>
														...
														<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
															<div class="modal-body">
																	<div class="form-group">
																		...
																		<input type="hidden" class="form-control" name="id_job" value="<?php echo $row['id_job'] ?>">
																	</div>
																</div>
													
														<div class="modal-footer">
															<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
															<button type="submit" name="subrevisi" class="btn btn-primary">Submit</button>
													    </div>
														</form>
												</div>
											</div>
										...
										<!-- end Modal -->
										<!-- Modal -->
										<div class="modal fade" id="eviden" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
											<div class="modal-dialog modal-dialog-centered" role="document">
												<div class="modal-content">
													<div class="modal-header">
													...
													<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
																<div class="modal-body">
																<div class="form-group">
																		<small class="form-text text-muted">Upload foto Eviden<b style="color:red;"> *</b> :</small>
																		<input type="file" class="form-control" id="comment" rows="5" name="eviden" required>
																	</div>
																		<input type="hidden" class="form-control" name="id_job" value="<?php echo $row['id_job'] ?>">
																		<input type="hidden" class="form-control" name="nama" value="<?php echo $row3['nama'] ?>">
																</div>
