					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-header" style="zoom:75%">
										<button class="btn btn-primary btn-round ml-auto pull-right" data-toggle="modal" data-target="#addRowModal1">
											<i class="fa fa-plus"></i>
											Add Job
										</button>
									
									<div class="d-flex align-items-center">
										<h3 class="card-title">BUMA-IPR</h3>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%; size:20px;">
											...
											<?php
												$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
												left join tb_karyawan k on k.nik=j.di_tujukan where status='Open' ;");
												$no=0;
												$no++;
												while($row=mysqli_fetch_array($query)){
													$idj=$row['id_job'];
												...
												<tr>
													...
													<td width="4%">
														<div class="form-button-action">
															...
															<a href="form_edit.php?id=<?=$idj;?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Detail">
