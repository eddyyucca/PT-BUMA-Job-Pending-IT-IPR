							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%; size:20px;">
											...
											<?php
												$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
												left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close','Progress') and lokasi='Panel 2';");
												$no=0;
												$no++;
												while($row=mysqli_fetch_array($query)){
													$idj=$row['id_job'];
											...
											<!--	<td><?php echo $row['cnunit'] ?></td>-->
													...
													<td>
														<div class="progress progress-xs progress-striped active">
															<div class="progress-bar bg-warning" style="width: <?php echo $row['progress'] ?>%"> <b><?php echo $row['progress'] ?> %</b></div>
														</div> 
													</td>
