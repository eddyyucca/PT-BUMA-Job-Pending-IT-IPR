...
<body data-background-color="bg3">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<div class="pull-left" style="color: aliceblue; font-size:medium;">
							...
							<a class="nav-link" href="dark/index.php">
		...
		<div class="main-panel">
			<div class="content">
				...
				<div class="page-inner">
									...
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title">
													<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' ;");
													echo mysqli_num_rows($jumlah_teknik); ?>
												 </h4>
											</div>
										</div>
									...
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title">
													<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' ;");
													echo mysqli_num_rows($jumlah_teknik); ?>
												</h4>
											</div>
										</div>
									...
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title"><?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Close' ;");
									...
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title"><?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' ;");
													echo mysqli_num_rows($jumlah_teknik); ?></h4>
											</div>
										</div>
									</div>
					...
					<?php  
						$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
						left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close','Open','Progress') and progress='25'  ;");
						while($row=mysqli_fetch_array($query)){
						$idj=$row['id_job']; 
					 ?>
						<div class="col-12 col-sm-6 col-md-2">
						<a href="forms2.php?id=<?=$idj;?>" style="text-decoration: none; color: black;">
							<div class="card">
								<div class="card-body">
						...
						<?php  
						$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
						left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close','Open','Progress') and progress='50'  ;");
						while($row=mysqli_fetch_array($query)){
						$idj=$row['id_job']; 
					 ?>
						<div class="col-12 col-sm-6 col-md-2">
						...
						<?php  
						$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
						left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close','Open','Progress') and progress='75'  ;");
						while($row=mysqli_fetch_array($query)){
						$idj=$row['id_job']; 
					 ?>
						<div class="col-12 col-sm-6 col-md-2">
						...
						<?php  
						$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
						left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close') and progress='100'  ;");
						while($row=mysqli_fetch_array($query)){
						$idj=$row['id_job']; 
					 ?>
						<div class="col-12 col-sm-6 col-md-2">
						<a href="forms2.php?id=<?=$idj;?>" style="text-decoration: none; color: black;">
							<div class="card">
								<div class="card-body">
									...
									<div class="progress progress-sm">
										<div class="progress-bar bg-primary w-<?php echo $row['progress'] ?>" role="progressbar" aria-valuenow="<?php echo $row['progress'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									<div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Progress</p>
										<p class="text-muted mb-0"><?php echo $row['progress'] ?>%</p>
								...
								<div class="form-group form-group-default">
									<div class="selectgroup w-100">
										<label class="selectgroup-item">
												<input type="radio" name="value" value="Open" class="selectgroup-input">
												<span class="selectgroup-button">No Progress</span>
											</label>
											<label class="selectgroup-item">
												<input type="radio" name="value" value="Progress" class="selectgroup-input">
												<span class="selectgroup-button">On Progress</span>
											</label>
											<label class="selectgroup-item">
									 			<input type="radio" name="value" value="Pending" class="selectgroup-input">
	...
	<script>
		...
		var myPieChart = new Chart(pieChart, {
			...
			data: {
				datasets: [{
					data: [<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -7 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>,
							<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -7 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 
							<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -7 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>],
		...
		var myMultipleLineChart = new Chart(multipleLineChart, {
			...
			data: {
				...
				datasets: [{
					...
					fill: true,
					borderWidth: 2,
					data: [	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -7 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at = DATE_ADD(CURDATE(), INTERVAL -6 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -5 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -4 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -3 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -2 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and update_at > DATE_ADD(CURDATE(), INTERVAL -1 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>]
				},{
					label: "On Progress",
					borderColor: "#00bfff",
					...
					fill: true,
					borderWidth: 2,
					data: [<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='On Progres' and update_at > DATE_ADD(CURDATE(), INTERVAL -7 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -6 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -5 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -4 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -3 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -2 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Progress' and update_at > DATE_ADD(CURDATE(), INTERVAL -1 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>]
				}, {
					label: "Open",
					borderColor: "#f3545d",
					...
					borderWidth: 2,
					data: [<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -7 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -6 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -5 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -4 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -3 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -2 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>, 	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Open' and update_at > DATE_ADD(CURDATE(), INTERVAL -1 DAY)");
							echo mysqli_num_rows($jumlah_teknik); ?>]
				}]
			},
			options : {
