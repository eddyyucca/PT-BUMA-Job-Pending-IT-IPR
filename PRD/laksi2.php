					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<?php  
									...
									left join tb_karyawan k on k.nik=j.di_tujukan where  status='Open' and di_tujukan='$g' ;");
			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="page-header">
						<h4 class="page-title">Pit Panel 2</h4>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%; size:20px;">
											...
											<?php
												$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
												left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close','Done','Progress') and lokasi='Panel 2' and di_tujukan='$g';");
												$no=0;
												$no++;
												while($row=mysqli_fetch_array($query)){
													$idj=$row['id_job'];
											?>
												...
												<td><?php echo $row['cnunit'] ?></td>
													...
													<td ><b style="font-size:18px; color:green;"><?php echo $row['progress'] ?> %</b></td>
													<td><?php echo $row['nama'] ?></td>
													<td><?php echo $row['update_at'] ?></td>
													<td width="4%">
														<div class="form-button-action">
															<a href="forms2.php?id=<?=$idj;?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Detail">
