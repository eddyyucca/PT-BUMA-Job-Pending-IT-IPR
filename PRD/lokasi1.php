			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="page-header">
						<h4 class="page-title">Pit Panel 1</h4>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%; size:20px;">
											...
											<?php
												$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
												left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Close','Done','Progress') and lokasi='Panel 1' and di_tujukan='$g';");
												$no=0;
												$no++;
												while($row=mysqli_fetch_array($query)){
													$idj=$row['id_job'];
											...
											?>
												...
												<td><?php echo $row['cnunit'] ?></td>
													...
													<td ><b style="font-size:18px; color:green;">100 %</b></td>
