...
<table style="width:100%; border:none; ">
  <tr style="font-size:14px; border:none;">
    ...
    <td width='15%' style="border:none;">Start</td>
    <td colspan="2" style="border:none;">: <?php echo$row['create_job'] ?></td>
  </tr>
  <tr style="font-size:15px; border:none;">
    <td width='15%' style="border:none;">End</td>
    <td colspan="2" style="border:none;">: <?php echo$row['update_at'] ?></td>
  </tr>
  <tr style="font-size:15px; border:none;">
    <td width='15%' style="border:none;">Total</td>
    <td colspan="2" style="border:none;">:<b> <?php $booking    =new DateTime($row['create_job']);
																					$today        =new DateTime($row['update_at']);
																				$diff = $today->diff($booking);
																				echo $diff->d; echo " Hari";?></b></td>
  </tr>
  <tr style="font-size:15px; border:none;">
