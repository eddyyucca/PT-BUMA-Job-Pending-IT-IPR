																	...
																	<div class="row">
																		<div class="col-md-5">
																			<div class="form-group">
																				...
																				<input type="text" class="form-control" name="nik" value="<?=$id;?>">
																			</div>
																		</div>
																		<div class="col-md-7">
																			<div class="form-group">
																				<label for="pillSelect">NO WA :</label>
																				<input type="text" class="form-control" name="#" value=" <?php echo $row['no_telp'] ?> ">
																			</div>
																		</div>
																	</div>
																	<div class="form-group">
																		<label for="pillSelect">SECTION :
																		<input type="text" class="form-control" name="telp" value=" <?php echo $row['nama_section'] ?> " disabled>
																	</div>
																	<div class="form-group">
																		<label for="pillSelect">JABATAN :
