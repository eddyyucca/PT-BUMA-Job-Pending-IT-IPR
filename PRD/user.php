						...
						<div class="pull-left" style="color: aliceblue; font-size:medium;">
							...
							<a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<span class="notification" style="background-color: red;">
													...
													<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status in ('Open') and di_tujukan='$g' ;");
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								<li>
									<div class="dropdown-title">You have <?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status in ('Open') and di_tujukan='$g';");
													echo mysqli_num_rows($jumlah_teknik); ?> Job</div>
								</li> 
								<li>
								<?php  
								$ambildatastock=mysqli_query($koneksi, "SELECT * FROM tb_job where status in ('Open') and di_tujukan='$g'");
								$no=0;
								$no++;
					...
					<div class="row">
								...
								<div class="card card-profile">
									...
									<div class="card-body">
										...
										<div class="desc">Welcome...</div>
											...
											<div class="view-profile">
												<a href="#" class="btn btn-secondary btn-block">Don't forget to be happy <b><?php echo $row3['nama'] ?></b> &#128521</a>
											</div>
										</div>
									</div>
									<div class="card-footer">
										<div class="row user-stats text-center">
											<div class="col">
												<div class="number"><b>	<?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status in ('Open','Pending') and di_tujukan='$g' ;");
													echo mysqli_num_rows($jumlah_teknik); ?></b></div>
												<div class="title">Job Open</div>
											</div>
											<div class="col">
												<div class="number"><b><?php $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_job where status='Done' and di_tujukan='$g';");
													echo mysqli_num_rows($jumlah_teknik); ?></h4></b></div>
												<div class="title">Job Close</div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-md-9">
								...
								<div class="card-header">
										...
										<div class="desc"><h5>Hi...  <?php echo $row3['nama'] ?></h5></div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="password" name="pwd" class="form-control form-control-sm" id="exampleInputPassword1" placeholder="Password" required>
											<small class="form-text text-muted">Change your password here.</small>
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Comfirm Password</label>
											<input type="password" name="pwds" class="form-control form-control-sm" id="exampleInputPassword1" placeholder="Password" required>
										</div>
										<button type="submit" name="updateuser" class="btn btn-default btn-sm pull-right">Update</button>
										</div>
									</form> 
									</div>
								</div>
								...
								<div class="card">
									<div class="card-header">
										<div class="d-flex align-items-center">
											...
											<button class="btn btn-primary btn-sm ml-auto pull-right" data-toggle="modal" data-target="#addRowModal2">
									...
									<div class="card-body">
										...
										<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%; size:20px;">
												...
												<?php
													...
													left join tb_section s on s.id_sec=k.section
													left join tb_jabatan j on j.id=k.id_jab where section='1' order by k.create_at desc;");
													$no=0;
													$no++;
													while($row=mysqli_fetch_array($query)){
														$id=$row['nik'];
												...
												?>
													<tr>
														...
														<td><div class="username"><b><?php echo $row['nama'] ?></b></div>
															   <div class="status"><?php echo $row['nik'] ?></div></td>
														...
														<td width="4%">
															...
															<button type="button" class="btn btn-link btn-primary" data-original-title="Remove" data-toggle="modal" data-target="#edituser<?=$id;?>">
													...
													<!-- Modal -->
													<div class="modal fade" id="edituser<?=$id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered" role="document">
															<div class="modal-content">
																<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
																	<div class="modal-header">
																		<h3 class="modal-title" id="exampleModalLongTitle">Form Edit</h3>
																	...
																	<div class="form-group">
																		<label for="pillSelect">NAMA :</label>
																		<input type="text" class="form-control" name="nama" value="<?php echo $row['nama'] ?>">
																	</div>
																	<div class="row">
																		<div class="col-md-5">
																			<div class="form-group">
																				<label for="pillSelect">NIK :</label>
																				<input type="number" class="form-control" name="nik" value="<?=$id;?>">
																			</div>
																		</div>
																		<div class="col-md-7">
																			<div class="form-group">
																				<label for="pillSelect">NO WA :</label>
																				<input type="nimber" class="form-control" name="telp" value=" <?php echo $row['no_telp'] ?> ">
																			</div>
																		</div>
																	</div>
																	<div class="form-group">
																		<label for="pillSelect">SECTION : &nbsp;<?php echo $row['nama_section'] ?></label>
																		<input type="text" class="form-control" name="#" value=" <?php echo $row['nama_section'] ?> " disabled>
																	</div>
																	<div class="form-group">
																		<label for="pillSelect">JABATAN : &nbsp;<?php echo $row['jabatan'] ?></label>
																		<input type="text" class="form-control" name="#" value=" <?php echo $row['jabatan'] ?> " disabled>
																	</div>
																	</div>
																	<input type="hidden" class="form-control" name="id" value="<?=$id;?>">
																	<div class="modal-footer">
																		<button type="submit" name="updateuser1" class="btn btn-primary">Submit</button>
																	</div>
																</form>
															</div> 
														</div>
													...
													<div class="modal-dialog" role="document">
														...
														<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
															...
															<div class="modal-body">
																 ...
																 <br><b>NIK : <?php echo $row['nik'] ?> / <?php echo $row['nama'] ?></b>
		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				...
				<div class="modal-body"> 
					...
					<div class="modal-footer no-bd">
							<button type="submit" name="adduser1" class="btn btn-primary btn-sm"><span class="btn-label "><i class="icon-user-follow"></i></span> Submit</button>
						</div>
					</form>
				</div>
			</div>
