							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%">
											...
											<?php
												$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
												left join tb_karyawan k on k.nik=j.di_tujukan where status='Progress' and di_tujukan='$g' ;");
												$no=0;
												$no++;
												while($row=mysqli_fetch_array($query)){
													$idj=$row['id_job'];
												...
												<tr>
													...
													<td width="4%">
														<div class="form-button-action">
														    <button type="button" class="btn btn-link btn-danger" data-original-title="Remove" data-toggle="modal" data-target="#pending<?=$idj;?>">
																<i class="fa icon-login"></i>
															</button>
															<a href="forms2.php?id=<?=$idj;?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
														...
														<div class="modal-content">
															<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
																<div class="modal-header">
																	<h5 class="modal-title" id="exampleModalLongTitle">Pendingan Di tujukan kepada</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">&times;</span>
																	</button>
																</div>
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<option></option>
																		<?php                                    
																		$querya=mysqli_query($koneksi, "SELECT * FROM tb_karyawan where section='1'" ) or die (mysqli_error($koneksi));
																	...
																	<textarea class="form-control" id="comment" name="ket" rows="4" placeholder="Beri Ket..."></textarea>
																</div>
																</div>
																<input type="hidden" class="form-control" name="id" value="<?=$idj;?>">
																<div class="modal-footer"> 
																	<button type="submit" name="pendingan" class="btn btn-primary">Submit</button>
																</div>
															</form>
														</div>
													</div>
											...
											<div class="modal fade" id="exampleModalLong<?=$idj;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
												<div class="modal-dialog" role="document">
													...
													<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
														...
														<div class="modal-footer">
															<button type="submit" name="deletejob" class="btn btn-danger">Delete</button>
														</div>
													</fomr>
													</div>
												</div>
