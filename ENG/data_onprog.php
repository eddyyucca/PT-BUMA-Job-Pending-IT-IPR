			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="page-header">
						<h4 class="page-title">Data On Progress</h4>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" style="zoom:95%">
											...
											<?php
												$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
												left join tb_karyawan k on k.nik=j.di_tujukan where status='Progress' ;");
												$no=0;
												$no++;
												while($row=mysqli_fetch_array($query)){
													$idj=$row['id_job'];
											...
											?>
												<tr>
													...
													<td><?php echo $row['status_ikh'] ?></td>
													<td><?php echo $row['problem'] ?></td>
													<td><?php echo $row['tindakan_perbaikan'] ?></td>
													<td><?php echo $row['lokasi'] ?></td>
													<td><?php echo $row['nama'] ?></td>
													<td> 
														<div class="progress progress-xs progress-striped active">

															<?php if($row['progress'] < 26){ ?>
															<div class="progress-bar progress-bar-striped bg-danger active" style=" width: <?php echo $row['progress'] ?>%"> <b><?php echo $row['progress'] ?> %</b></div>

														<?php  }elseif($row['progress'] > 49) {  ?>
															<div class="progress-bar progress-bar-striped bg-warning active" style=" width: <?php echo $row['progress'] ?>%"> <b><?php echo $row['progress'] ?> %</b></div>

													<?php	}elseif($row['progress'] > 74) { ?>
														<div class="progress-bar progress-bar-striped bg-primary active" style=" width: <?php echo $row['progress'] ?>%"> <b><?php echo $row['progress'] ?> %</b></div>

														<?php	}elseif($row['progress'] > 99) { ?>
															<div class="progress-bar progress-bar-striped bg-success active" style=" width: <?php echo $row['progress'] ?>%"> <b><?php echo $row['progress'] ?> %</b></div>
															<?php } ?>
														</div> 
													</td>
													...
													<td width="4%">
														<div class="form-button-action">
															<a href="forms2.php?id=<?=$idj;?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit<?=$idj;?>">
																<i class="fa fa-edit"></i>
															</a>
															<button type="button" class="btn btn-link btn-danger" data-original-title="Remove" data-toggle="modal" data-target="#exampleModalLong<?=$idj;?>">
												...
												<!-- Modal -->
												<div class="modal fade" id="pending<?=$idj;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
											...
											<!-- Modal Delete -->
											<div class="modal fade" id="exampleModalLong<?=$idj;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
												<div class="modal-dialog" role="document">
													...
													<form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
														...
														<div class="modal-body">
															 ...
															 <br><b>CN Unit : <?php echo $row['cnunit'] ?></b>
															<input type="hidden" class="form-control" name="id_job" value="<?=$idj;?>">
														</div>
														<div class="modal-footer">
															<button type="submit" name="deletejob1" class="btn btn-danger">Delete</button>
														</div>
													</fomr>
													</div>
												</div>
											...
											<!-- Modal Edit -->
											<div class="modal fade bd-example-modal-lg" id="edit<?=$idj;?>" tabindex="-1" role="dialog" aria-hidden="true">
												<div class="modal-dialog modal-lg" role="document">
													<div class="modal-content">
