...
<body data-background-color="dark">
	<div class="wrapper sidebar_minimize">
		<div class="main-header">
			...
			<!-- Navbar Header -->
			<nav class="navbar navbar-header navbar-expand-lg bg-primary " data-background-color="dark">
				...
				<div class="page-inner">
					...
					<?php  
							...
							<div class="card">
								<div class="card-body">
									<div class="d-flex justify-content-between">
										...
										<p  class="text-muted"><?php echo $row['update_at'] ?></p>
											<h5  class="text-muted"><b><?php echo $row['aktivitas'] ?></b></h5>
					 ...
					 ?>
						...
						<?php  
						$query=mysqli_query($koneksi, "SELECT *	FROM tb_job j
						left join tb_karyawan k on k.nik=j.di_tujukan where status in ('Done') and progress='100'  ;");
						while($row=mysqli_fetch_array($query)){
						$idj=$row['id_job']; 
					 ?>
						<div class="col-12 col-sm-6 col-md-2">
